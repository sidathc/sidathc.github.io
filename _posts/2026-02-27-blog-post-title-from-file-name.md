...
These plots were interesting for some familiarity with the dataset and revealed some interesting trends, which will be interesting to note later on whether these will remain the same after importing a larger set of data from the API, or whether I will see very different trends when narrowing it down to Australia. 
